...
#
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/aivrar/portable-hermes-agent/main/scripts/install.sh | bash
#
# Or with options:
...
# Configuration
REPO_URL_SSH="git@github.com:aivrar/portable-hermes-agent.git"
REPO_URL_HTTPS="https://github.com/aivrar/portable-hermes-agent.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  iex (irm https://raw.githubusercontent.com/aivrar/portable-hermes-agent/main/scripts/install.ps1)"
            exit 1
            ;;
        *)
            OS="unknown"
